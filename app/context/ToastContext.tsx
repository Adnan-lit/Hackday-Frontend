...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: (id: string) => void }) {
  ...
  return (
    <div
      className={`${bgColors[toast.type]} pointer-events-auto flex items-center gap-3 rounded-full px-5 py-3 text-white shadow-lg backdrop-blur-sm animate-slide-in-right`}
      role="alert"
      aria-live="polite"
    >
